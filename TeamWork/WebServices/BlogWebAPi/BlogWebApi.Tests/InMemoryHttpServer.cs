...
namespace Forum.Tests
{
    class InMemoryHttpServer
    {
        ...
        public InMemoryHttpServer(string baseUrl) : this(baseUrl, new List<Route>())
        {
        }
        ...
        public HttpResponseMessage Put(string requestUrl, object data = null, IDictionary<string, string> headers = null, string mediaType = "application/json")
        {
