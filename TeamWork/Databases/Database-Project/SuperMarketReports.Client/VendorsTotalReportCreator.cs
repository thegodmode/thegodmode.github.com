...
namespace SuperMarketReports.Client
{
    public class VendorsTotalReportCreator
    {
        ...
        private bool IsCorrectMonth(string date)
        {
            ...
            switch (curMonth)
            {
                case 1: if (month == "jan") { return true; }; break;
                case 2: if (month == "feb") { return true; }; break;
                case 3: if (month == "mar") { return true; }; break;
                case 4: if (month == "apr") { return true; }; break;
                case 5: if (month == "may") { return true; }; break;
                case 6: if (month == "jun") { return true; }; break;
                case 7: if (month == "jul") { return true; }; break;
                case 8: if (month == "aug") { return true; }; break;
                case 9: if (month == "sep") { return true; }; break;
                case 10: if (month == "oct") { return true; }; break;
                case 11: if (month == "nov") { return true; }; break;
                case 12: if (month == "dec") { return true; }; break;
                default:
                    return false;
                    break;
            }
